...
export default async function AccountPage() {
  if (!isSupabaseConfigured()) return <div className="min-h-screen bg-[#F6F3EE]"><Header compact/><main className="mx-auto max-w-3xl px-4 py-24"><section className="rounded-[32px] border border-[#E5E0D8] bg-white p-10"><h1 className="text-4xl font-semibold">Connect Supabase to enable accounts</h1><p className="mt-4 text-[#7C7A74]">Copy .env.example to .env.local and add your project URL and publishable key.</p></section></main></div>;
