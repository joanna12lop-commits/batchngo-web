      ...
      {open ? (
        <div className="border-t border-[#E5E0D8] bg-white/98 md:hidden">
          <div className="mx-auto flex max-w-[1280px] flex-col gap-3 px-5 py-5 sm:px-8">
            ...
            <Link href="/login" className="rounded-2xl px-4 py-3 text-sm font-medium text-[#1F2937] transition hover:bg-[#EEF1E8] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#7C8A6A]" onClick={() => setOpen(false)}>Log in</Link>
